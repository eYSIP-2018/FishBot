...
int frequency = 4; // Oscillation frequency of segments.
int amplitude = 100; // Amplitude of the serpentine motion of the snake
...
int delayTime = 70; // Delay between limb movements
...
/*
    for(counter = 0; counter < 10; counter += 1)  {
      delay(delayTime);
      Serial.print("S1:");
      Serial.print(90+offset+.1*counter*rightOffset+amplitude*cos(frequency*counter*3.14159/180+1*lag));
      Serial.print("   S2:");
      Serial.println(90+offset+.1*counter*rightOffset+amplitude*cos(frequency*counter*3.14159/180+2*lag));
      servo2.write(90+offset+.1*counter*rightOffset+amplitude*cos(frequency*counter*3.14159/180+1*lag));
      servo3.write(90+offset+.1*counter*rightOffset+amplitude*cos(frequency*counter*3.14159/180+2*lag));
...
for(counter = 0; counter < 10; counter += 1)  {
      delay(delayTime);
      Serial.print("S1:");
      Serial.print(190-(90+offset+.1*counter*leftOffset+amplitude*cos(frequency*counter*3.14159/180+1*lag)));
      Serial.print("   S2:");
      Serial.println(190-(90+offset+.1*counter*leftOffset+amplitude*cos(frequency*counter*3.14159/180+2*lag)));
      servo2.write(190-(90+offset+.1*counter*leftOffset+amplitude*cos(frequency*counter*3.14159/180+1*lag)));
      servo3.write(190-(90+offset+.1*counter*leftOffset+amplitude*cos(frequency*counter*3.14159/180+2*lag)));
      //s3.write(90+offset+.1*counter*rightOffset+amplitude*cos(frequency*counter*3.14159/180+3*lag));
      //s4.write(90+.1*counter*rightOffset+amplitude*cos(frequency*counter*3.14159/180+2*lag));
